...
public class Materials {
    ...
    public static final Material[] GLASSES = {Material.GLASS, Material.BLACK_STAINED_GLASS,
            Material.BLUE_STAINED_GLASS, Material.BROWN_STAINED_GLASS, Material.CYAN_STAINED_GLASS,
            Material.GRAY_STAINED_GLASS, Material.GREEN_STAINED_GLASS, Material.LIGHT_BLUE_STAINED_GLASS,
            Material.LIGHT_GRAY_STAINED_GLASS, Material.LIME_STAINED_GLASS, Material.MAGENTA_STAINED_GLASS,
            Material.ORANGE_STAINED_GLASS, Material.PINK_STAINED_GLASS, Material.PURPLE_STAINED_GLASS,
            Material.RED_STAINED_GLASS, Material.TINTED_GLASS, Material.WHITE_STAINED_GLASS,
            Material.YELLOW_STAINED_GLASS};

    public static final Material[] GLASS_PANES = {Material.GLASS_PANE, Material.BLACK_STAINED_GLASS,
    ...
    public static final Material[] CONTAINERS = {Material.BARREL, Material.CHEST, Material.ENDER_CHEST,
            Material.TRAPPED_CHEST, Material.CRAFTING_TABLE, Material.FURNACE, Material.BLAST_FURNACE, Material.SMOKER,
            Material.DISPENSER, Material.DROPPER, Material.ENCHANTING_TABLE, Material.ANVIL, Material.HOPPER,
            Material.GRINDSTONE, Material.CARTOGRAPHY_TABLE, Material.LOOM, Material.SMITHING_TABLE,
            Material.STONECUTTER, Material.BREWING_STAND, Material.BEACON, Material.SHULKER_BOX,
